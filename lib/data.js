...
export const PROJECTS = [
    // Projet 1
        {
            ...
            description: "Une application web complète destinée aux établissements éducatifs qui facilite la gestion des étudiants, des enseignants, des cours et des absences. Développée avec React pour le front-end, Laravel pour le back-end et MySQL comme base de données. L’application propose un système de présence, un emploi du temps hebdomadaire, des graphiques interactifs ainsi qu’un système d’authentification avec gestion des rôles.",
            stack: ["React", "TailwindCss", "Laravel", "SQL"],
            github: "https://github.com/Said-Bzioui/School-Managment",
            photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756639301/dashboard_vrhnrb.png",
            Features: [
                "Enregistrement et visualisation de la présence des étudiants",
                "Emploi du temps hebdomadaire avec intégration de calendrier",
                "Graphiques dynamiques pour les absences et présences",
                "Authentification et gestion des accès basés sur les rôles"
            ]
        },  // Project 2
    {
        id: 2,
        title: "My First Portfolio",
        description: "Mon premier site portfolio personnel pour présenter mes projets, mes compétences et mes réalisations. Construit avec HTML, CSS et JavaScript, il intègre un design moderne, une mise en page responsive et une navigation intuitive.",
        stack: ["HTML", "CSS", "Js"],
        link: "https://said-bzioui.github.io/portfolio/",
        github: "https://github.com/Said-Bzioui/portfolio",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756639262/img_1_kl088v.png",
        Features: [
        ]
    },
    // Project 3
    {
        id: 3,
        title: "Résevation de services",
        description: "Une plateforme de réservation de services en ligne, développée dans le cadre d'un projet de stage. Elle permet aux utilisateurs de réserver divers services via une interface intuitive et moderne.",
        stack: ["React.js", "ShadCN", "TailwindCss", "API", "Laravel", "SQL"],
        link: "https://servio.ma/",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1757199293/sevio_o5z3js.png",
        Features: [
            "Système de réservation en ligne",
            "Interface utilisateur moderne et responsive",
            "Intégration d'API pour la gestion des services",
            "Back-end robuste avec Laravel et SQL"
        ]
    },  // Project 4
    {
        id: 4,
        title: "Creative Agency  Web Site",
        description: "Un site vitrine pour une agence créative qui propose des services de conception et de développement web. Réalisé avec HTML, CSS et JS, il présente une landing page moderne avec un style épuré.",
        stack: ["HTML", "CSS", "Js"],
        link: "https://said-bzioui.github.io/Tamplate-6-html-css-JS/",
        github: "https://github.com/Said-Bzioui/Tamplate-6-html-css-JS",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756639236/img_1_oi83vx.png",
        Features: [
        ]
    },
    // Project 5
    {
        id: 5,
        title: "Learning Academy Web Site",
        description: "Un site dédié à une académie éducative qui présente des cours, formations et services pédagogiques. Développé en HTML, CSS et JS avec un design simple, clair et responsive.",
        stack: ["HTML", "CSS", "Js"],
        link: "https://said-bzioui.github.io/Learning-Academy-Web-Site/",
        github: "https://github.com/Said-Bzioui/Learning-Academy-Web-Site",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756639185/img_4_nxpwwq.png",
        Features: [
        ]
    },
    // Project 6
    {
        id: 6,
        title: "Simple Restorant Home Page",
        description: "Une page d’accueil pour un restaurant présentant les services, le menu et les informations de contact. Créée avec HTML, CSS et JS, avec une mise en page moderne et responsive.",
        stack: ["HTML", "CSS"],
        link: "https://said-bzioui.github.io/Simple_Restorant_Home-Page/",
        github: "https://github.com/Said-Bzioui/Simple_Restorant_Home-Page",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756639155/img_1_rgiidh.png",
        Features: [
        ]
    },
    // Project 7
    {
        id: 7,
        title: "Academy Project  Web Site",
        description: "Une landing page destinée à une institution éducative, conçue avec Bootstrap pour garantir un design réactif et structuré. Elle met en valeur les informations académiques et les services proposés.",
        stack: ["HTML", "CSS","Bootstrap"],
        link: "https://said-bzioui.github.io/Tamplate-5-html-css-Bootstrap/",
        github: "https://github.com/Said-Bzioui/Tamplate-5-html-css-Bootstrap",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756639122/img_1_hmnawh.png",
        Features: [
        ]
    },
    // Project 8
    {
        id: 8,
        title: "Dashboard Tampelate",
        description: "Un modèle de tableau de bord (Dashboard) avec des composants UI réutilisables comme les tableaux, cartes et graphiques. Réalisé en HTML, CSS et JS, il peut servir de base pour des projets plus complexes.",
        stack: ["HTML", "CSS", "Js"],
        link: "https://said-bzioui.github.io/Tamplate-4-html-css-DASHBOARD/",
        github: "https://github.com/Said-Bzioui/Tamplate-4-html-css-DASHBOARD",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756639102/img_1_vezd8e.png",
        Features: [
        ]
    },
    // Project 9
    {
        id: 9,
        title: "Animated front-End web site",
        description: "Un site expérimental utilisant des animations CSS  pour offrir une expérience utilisateur dynamique. Conçu pour démontrer mes compétences en animations front-end.",
        stack: ["HTML", "CSS"],
        link: "https://said-bzioui.github.io/Tamplate-3-html-css-Animations/",
        github: "https://github.com/Said-Bzioui/Tamplate-3-html-css-Animations",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756639007/img_1_hselfo.png",
        Features: [
        ]
    },
    // Project 10
    {
        id: 10,
        title: "front-End web site",
        description: "Un modèle simple de site web front-end, développé avec HTML et CSS,Il se distingue par une interface propre et intuitive.",
        stack: ["HTML", "CSS"],
        link: "https://said-bzioui.github.io/Tamplate-2-html-css/",
        github: "https://github.com/Said-Bzioui/Tamplate-2-html-css",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756638976/img_1_d5l4pv.png",
        Features: [
        ]
    },
    // Project 11
    {
        id: 11,
        title: "front-End web site",
        description: "Une landing page expérimentale développée uniquement avec HTML et CSS. Le but était de pratiquer le responsive design et la structuration d’un site depuis zéro.",
        stack: ["HTML", "CSS"],
        link: "https://said-bzioui.github.io/Tamplate-one-html-css/",
        github: "https://github.com/Said-Bzioui/Tamplate-one-html-css",
        photo: "https://res.cloudinary.com/datjizbe8/image/upload/v1756638708/landing_n0x2ub.png",
        Features: [
        ]
    },
...
export const CERTIFICATES = [
    {
        photo: 'https://res.cloudinary.com/datjizbe8/image/upload/v1756657527/c4_dexeov.jpg'

    },
    {
        photo: 'https://res.cloudinary.com/datjizbe8/image/upload/v1756657227/C3_fkzgez.png'

    },
    {
        photo: 'https://res.cloudinary.com/datjizbe8/image/upload/v1756657080/c1_st5h37.jpg'
    },
    {
        photo: 'https://res.cloudinary.com/datjizbe8/image/upload/v1756657075/c2_zncvex.jpg'
    ...
    {
        photo: 'https://res.cloudinary.com/datjizbe8/image/upload/v1756657089/c3_wzsbud.jpg'
    }
]
// EDUCATIONS
