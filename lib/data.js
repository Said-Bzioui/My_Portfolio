...
export const PROJECTS = [
    // Project 1
    {
        ...
        description: " est une application Web qui simplifie la gestion des étudiants, la planification des cours, le suivi des présences, etc. Elle est conçue pour permettre aux établissements d'enseignement de gérer efficacement leurs opérations académiques quotidiennes.",
    ...
    // Project 2
    {
        ...
        description: "A personal portfolio website showcasing my projects, skills, and achievements. Built with React and TailwindCss, it features a modern design, responsive layout, and interactive sections for visitors to explore my work.",
        stack: ["HTML", "CSS", "Js"],
